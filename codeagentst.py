...
async def codeagentprocess():
    ...
    returntxt = returntxt + result.output.strip()

    return returntxt

def codeagentst():
    result = asyncio.run(codeagentprocess())
    txtoutput = result
    st.markdown(txtoutput, unsafe_allow_html=True)